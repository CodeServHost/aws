  ...
  <main>
    <div id="breadcrumb-bg" class="">
      <div class="container-fluid">
        <div class="breadcrumb-link">
          <h3 data-aos="fade-right" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-once="true">Contact Us</h3>
    ...
    <section id="contact">
      <div class="container-fluid">
        <h2>Contact Us</h2>
        <div class="row mt-5">
          <div class="col-md-4 border border-left-0 border-top-0 border-bottom-0" data-aos="fade-right" data-aos-easing="ease-in-back" data-aos-delay="400" data-aos-offset="0" data-aos-once="true">
            ...
            <div class="row justify-content-start">
              ...
              <div class="col-md-10 col-sm-10 col-10">
                ...
                <p>202 Bhola Market Durgapuri Red Light,<br> Loni Rd, Shahdara,<br> Delhi, 110094</p><br>
                <h5>Mobile</h5>
                <p>+91 9870337825 </p>
                <br>
                <h5>Email</h5>
                <p>info@anyawebsolution.in, anyawebsolution@gmail.com</p>
              </div>
            </div>
          </div>
          <div class="col-md-8" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="500" data-aos-offset="0" data-aos-once="true">
        ...
        <div class="mapouter" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="400" data-aos-offset="0" data-aos-once="true">
          <div class="gmap_canvas"><iframe width="100%" height="400" id="gmap_canvas" src="https://maps.google.com/maps?q=anyawebsolution&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://yggtorrent-fr.com"></a><br>
            <style>
              .mapouter {
                position: relative;
                text-align: right;
            ...
            </style><a href="https://www.embedgooglemap.net">google maps iframe generator</a>
            <style>
              .gmap_canvas {
                overflow: hidden;
