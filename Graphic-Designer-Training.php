...
<body>
    ...
    <section id="graphic-designing-banner">

        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="ban-cover">
                        <p class="ban-head text-white animate__animated animate__zoomIn">Graphic Design Course(Training) in Shahdara </p>
                        <p class="ban-para text-white animate__animated animate__zoomIn">Photoshop | Illustrator | Coreldraw | InDesign | Canva | Filmora </p>
    ...
    <main>
            ...
            <div class="container-fluid">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <div class="gd-course">
                            <img src="images/graphic-design/coreldraw.jpeg" alt="">
                ...
                <div class="row mt-4">
                    <div class="col-md-4 col-sm-4">
                        ...
                        <div class="gd-course">
                            <img src="images/graphic-design/indesign.jpeg" alt="">
                            <a href="courses/adobe-indesign-training-certification-delhi-shahdara.html">
                                <h3>In Design</h3>
                                <p>Desktop Publishing page layout</p>
                            </a>
                        </div>
        ...
        <section id="why_learn_graphic">
            <div class="container-fluid">
                <h3 class="text-center"><span class="text-primary">W</span>hat <span class="text-primary">i</span>s <span class="text-primary">G</span>raphic <span class="text-primary">D</span>esign?</h3>
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-12">
                        <img src="images/graphicdesign.jpeg" alt="" class="side-img">
                    </div>
                    <div class="col-md-6 col-sm-12 col-12">
                        <p>
                            Graphic Design is an art known as visual communication design. Visual communicators, who create visual concepts by hand or by using computer software. Graphic Design is used to create visual content such as images, words, graphics colors, typography, illustrations, and icons. Graphic Designer develops the overall layout and production design for applications such as Display advertisements, Industrial brochures, magazines, Banners, Book Work newspapers, flyers, posters, labels, bills, logos, brochures, visiting cards, banners, wrappers, hoarding reports, etc.
                        </p>
                        <a href="./files/Graphic-Design-course.pdf" target="_blank"><button>Download Course PDF</button></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div id="faq">
            ...
            <div class="card">
                <div class="card-header" id="headingOne">
                    <h5 class="mb-0">
                        <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            <b>Q1.</b> What are the benefits of enrolling in a graphic design course?
                        </button>
                    </h5>
                </div>
                ...
                <div id="collapseOne" class="common collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body">
                        <b>Ans.</b> A professional graphic design course can give you valuable hands-on experience in both designing and understanding the various aspects of good design that you might not be able to learn just from a book or online tutorial.
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="headingTwo">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            <b>Q2.</b> What design areas do I learn and gain expertise in the graphic design course?
                        </button>
                    </h5>
                </div>
                <div id="collapseTwo" class="common collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                    <div class="card-body">
                        <b>Ans.</b> You will learn design principles, typography, color theory, layout principles, marketing strategies and much more. You will be encouraged to enhance your skills and knowledge in software and design. You will explore all areas of design!
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="headingThree">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            <b>Q3.</b> Which is the best institute for graphic design in Delhi Shahdara?
                        </button>
                    </h5>
                </div>
                <div id="collapseThree" class="common collapse" aria-labelledby="headingThree" data-parent="#accordion">
                    <div class="card-body">
                        <b>Ans.</b> AWS is a leading graphic design training institute that offers the best training at affordable prices. The institute also has a 100% job placement rate. 100 of the alumni is work at major creative firms in top positions. Mr. Ram, founder of AWS, has 15 years of experience in this field and will give you sound knowledge.
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="headingFour">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                            <b>Q4.</b> What software tools and visual programs I learn in a graphic design work?
                        </button>
                    </h5>
                </div>
                <div id="collapseFour" class="common collapse" aria-labelledby="headingFour" data-parent="#accordion">
                    <div class="card-body">
                        <b>Ans.</b> The Course will make you proficient in Adobe Creative Suite (Photoshop, Illustrator, InDesign), Corel Draw, Canva pro, Wondershare, Filmora, and more that. These essential programs can only be learned through extensive Graphic Design course.
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="headingFive">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                            <b>Q5.</b> I am currently attending high school. Can I participate in this course?
                        </button>
                    </h5>
                </div>
                <div id="collapseFive" class="common collapse" aria-labelledby="headingFive" data-parent="#accordion">
                    <div class="card-body">
                        <b>Ans.</b> Yes, of course you can participate in this course, no special eligibility is required. A graphic design course will open doors to a wealth of career opportunities in the world of art and design. Always remember that there will never be a dull moment or a low phase in your career path because graphic design is a broad industry that is constantly evolving.
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="headingSix">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                            <b>Q6.</b> Why I should choose graphic designing course and why it's worth my time and effort?
                        </button>
                    </h5>
                </div>
                <div id="collapseSix" class="common collapse" aria-labelledby="headingSix" data-parent="#accordion">
                    <div class="card-body">
                        <b>Ans.</b> In our increasingly digital world, the ability to create beautiful and effective visual communications is more important than ever. In India, the design and creative industry is one of the fastest growing industries in recent years. You will grow as a professional and individual designer and have the opportunity to communicate with elite clients and audiences in a way that is creative, innovative and unique.
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="headingSeven">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                            <b>Q7.</b> Besides professional visual softwares, what practical knowledge will I acquire in a graphic designer course?
                        </button>
                    </h5>
                </div>
                <div id="collapseSeven" class="common collapse" aria-labelledby="headingSeven" data-parent="#accordion">
                    <div class="card-body">
                        <b>Ans.</b> This course will not only provide you with knowledge of the visual arts and software skills, but also with the ability to develop creative solutions such as offset and screen printing, brand strategies, interactive design, industrial design, advertising campaigns, etc., that will make you applicable and employable in multiple fields.
                    </div>
                </div>
            </div>
        </div>
